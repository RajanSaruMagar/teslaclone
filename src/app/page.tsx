        ...
        return (
          ...
          >
            <div className="flex items-center justify-between flex-col h-[70%] absolute top-[15%] left-[25%] right-[25%]">
              <div>
                {index == 4 ? (
                  <div className="font-semibold text-white text-[40px]">
                    {car.title}
                  </div>
                ) : (
                ...
                {index == 4 ? (
                  <p className="text-[17px] text-white underline">
                    {car.price}
              ...
              <div className="flex h-10 justify-center w-[552px]  gap-x-6">
                {index == 7 ? (
                  <button className="bg-white font-medium text-[#8e8e8e] text-[#14px] rounded-md w-60 ">
                    Shop Now
                  </button>
                ) : (
                  <>
                    <button
                      className={clsx(
                        " text-[#8e8e8e] font-semibold py-1 px-6 w-full",
                        index == 3
